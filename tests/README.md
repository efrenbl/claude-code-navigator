...
python -m pytest tests/test_code_mapper.py::TestPythonAnalyzer -v

# Run a specific test
python -m pytest tests/test_code_mapper.py::TestPythonAnalyzer::test_simple_function -v
...
- `test_code_mapper.py`: Tests for the CodeMapper, PythonAnalyzer, and GenericAnalyzer classes
...
def test_search_uses_codemap(sample_codemap):
    # Use the fixture
    pass
```
