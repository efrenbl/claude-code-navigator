...
```python
from code_map_navigator import CodeSearcher, LineReader
...
code-search "handler" -m .codemap-src.json
...
code-map . -i "test_*.py" "*_test.py" "*_generated.py" "migrations/"

# Exclude large auto-generated files
code-map . -i "*.min.js" "*.bundle.js" "vendor/"
```
...
def validate_codemap(map_path, root_path):
